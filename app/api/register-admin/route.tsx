...
const DOMAIN = process.env.NODE_ENV === 'production' ? process.env.DOMAIN : 'localhost:3000';
...
export async function POST(request: Request): Promise<void | Response> {
    ...
    if(!user){
      ...
      const confirmationLink = `${PROTOCOL}://${DOMAIN}/auth/admin/confirm-email/${user.id}`;
        ...
        const data = client.sendEmail({
          ...
          "Subject": "Confirm your email",
            ...
            <div style="background-color: #FFFFFF; padding: 35px; border-radius: 10px;">
                ...
                <p style="color: #000000; font-size: 14px; line-height: 22px"><strong>Thank you for signing up to Rent Spaces. We are happy to have you on board. To start exploring PinnedAds, please take a second to confirm your email address.</strong></p>
            ...
            <p style="color: #969696; font-size: 13px; text-align: center; margin-top: 5px; text-decoration: none;">133, Ahmadu Bello way, Victoria Island, Lagos.</p>
            </div>
        `,
